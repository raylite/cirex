...
class Result(db.Model):   
    ...
    freq_mesh_terms = db.Column(LONGTEXT())
    tfidf_mesh_terms = db.Column(LONGTEXT())
    ...
    tfidf_uniquecount_preds = db.Column(LONGTEXT())
    tfidf_multicount_preds = db.Column(LONGTEXT())
    fishers_uniquecount_preds = db.Column(LONGTEXT())
    fishers_multicount_preds = db.Column(LONGTEXT())
    chi_uniquecount_preds = db.Column(LONGTEXT())
    chi_multicount_preds = db.Column(LONGTEXT())
    search_id = db.Column(db.Integer, db.ForeignKey('search.id'))